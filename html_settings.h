...
const char PAGE_settingsCss[] PROGMEM = R"=====(body{font-family:var(--cFn),sans-serif;text-align:center;background:#202223;color:#e9f0f5;line-height:200%;margin:0;background-attachment:fixed}hr{border-color:#26292b;filter:drop-shadow(-5px -5px 5px #cc35a4)}button{background:#101213;color:white;font-family:var(--cFn),sans-serif;border:.3ch solid #101213;display:inline-block;filter:drop-shadow(-5px -5px 5px #cc35a4);font-size:20px;margin:8px;margin-top:12px}.helpB{text-align:left;position:absolute;width:60px}input{background:#101213;color:white;font-family:var(--cFn),sans-serif;border:.5ch solid #101213;filter:drop-shadow(-5px -5px 5px #cc35a4)}input[type=number]{width:4em}select{background:#101213;color:white;font-family:var(--cFn),sans-serif;border:0.5ch solid #101213;filter:drop-shadow( -5px -5px 5px #cc35a4 );}td{padding:2px;}</style>)=====";


//settings menu
const char PAGE_settings0[] PROGMEM = R"=====(<!DOCTYPE html>
<html><head><title>Luminxa Settings</title>)=====";

const char PAGE_settings1[] PROGMEM = R"=====(body{text-align:center;background:#202223;height:100%;margin:0;background-attachment:fixed}html{--h:11.55vh}button{background:#101213;color:#e9f0f5;font-family:var(--cFn),Helvetica,sans-serif;border:.3ch solid #101213;display:inline-block;filter:drop-shadow(-5px -5px 5px #cc35a4);font-size:8vmin;height:var(--h);width:95%;margin-top:2.4vh}</style>
...
<title>WiFi Settings</title><script>function H(){window.open("https://luminxa.com/wiki/Settings#wifi-settings");}function B(){window.history.back();}function GetV(){var d = document;)=====";
...
<html><head><meta name="viewport" content="width=500">
<title>LED Settings</title><script>function H(){window.open("https://luminxa.com/wiki/Settings#led-settings");}function B(){window.history.back();}function S(){GetV();UI();}function UI(){
...
function gId(s){return document.getElementById(s);}function S(){GetV();Ct();}function H(){window.open("https://luminxa.com/wiki/Settings#user-interface-settings");}function B(){window.history.back();}function Ct(){if (gId("co").selected){gId("cth").style.display="block";}else{gId("cth").style.display="none";}}function GetV(){var d = document;)=====";
...
<script>function H(){window.open("https://luminxa.com/wiki/Settings#sync-settings");}function B(){window.open("/settings","_self");}function GetV(){var d = document;)=====";
...
<a href="https://luminxa.com/wiki/Infrared-Control" target="_blank">IR info</a>
<h3>Luminxa Broadcast</h3>
...
<i>Clear the token field to disable. </i><a href="https://luminxa.com/wiki/Blynk" target="_blank">Setup info</a>
<h3>MQTT</h3>
Broker: <input name="MS" maxlength="32"><br>
Device Topic: <input name="MD" maxlength="32"><br>
Group Topic: <input name="MG" maxlength="32"><br>
<i>Reboot required to apply changes. </i><a href="https://luminxa.com/MQTT" target="_blank">MQTT info</a>
<h3>Philips Hue</h3>
...
<script>function H(){window.open("https://luminxa.com/wiki/Settings#security-settings");}function B(){window.open("/settings","_self");}function U(){window.open("/update","_self");}function GetV(){var d = document;)=====";
...
<h3>About</h3>
<a href="https://luminxa.com" target="_blank">Luminxa</a> version 0.8.3<br><br>
